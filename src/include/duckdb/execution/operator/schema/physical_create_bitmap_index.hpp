...
//                         DuckDB
//
// duckdb/execution/operator/schema/physical_create_bitmap_index.hpp
//
//
//===----------------------------------------------------------------------===//
...
class PhysicalCreateBITMAPIndex : public PhysicalOperator {
public:
	static constexpr const PhysicalOperatorType TYPE = PhysicalOperatorType::CREATE_INDEX;

public:
	PhysicalCreateBITMAPIndex(LogicalOperator &op, TableCatalogEntry &table, const vector<column_t> &column_ids,
