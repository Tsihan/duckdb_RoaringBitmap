...
def main():
    ...
    with open('execution_times.csv', 'w', newline='') as csvfile:
        ...
        # Create the schema
        execute_sql_file('/home/xuzhilong/duckdb/benchmark/imdb_plan_cost/init/schema.sql', csv_writer)

        # Load the data
        execute_sql_file('/home/xuzhilong/duckdb/benchmark/imdb_plan_cost/init/load.sql', csv_writer)
