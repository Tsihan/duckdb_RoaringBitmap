...
def main():
    ...
    # Create index
    create_indexes_sql_path = '/home/xuzhilong/gaowanen/tpchData/tpch-index.sql'
    execution_times.append(run_sql_from_file(conn, create_indexes_sql_path))
    ...
    csv_file_path = '/home/xuzhilong/gaowanen/tpchResults/tpch_v1_with_index/execution_times.csv'
